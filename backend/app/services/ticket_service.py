...
class TicketService:
    def __init__(self):
        ...
        self._initialize_seed_tickets()

    def _initialize_seed_tickets(self):
        """Seeds a small, realistic set of 10 demo campus IT incidents across diverse categories."""
        self._tickets = [
            TicketResponse(
                id="t-seed-1042",
                ...
                actions_taken=[
                    ActionLogItem(id="act-1042-1", timestamp="2026-08-29T08:30:00Z", action="Analyzed RADIUS authentication logs for AP-UB301/302", actor="ai_specialist", result="Discovered frequent EAP-TLS packet drop during 802.1X key exchange"),
                    ActionLogItem(id="act-1042-2", timestamp="2026-08-29T08:45:00Z", action="Assigned to Network Specialist Alex Rivera", actor="system", result="Dispatched for access point channel audit")
                ],
                resolution_details=None,
                escalation_info=None,
                chat_transcript=None,
                notes=[
                    TicketNote(id="note-1042-1", author="Alex Rivera", author_role="technician", text="Rebooted access point AP-UB301. Monitoring client association rates.", created_at="2026-08-29T09:00:00Z")
                ],
            ...
            TicketResponse(
                ...
                actions_taken=[
                    ActionLogItem(id="act-1043-1", timestamp="2026-08-29T08:50:00Z", action="Gathered RSSI signal heatmaps from NTR Library AP-LIB201", actor="ai_specialist", result="Identified co-channel interference on 5GHz Band 1")
                ],
                resolution_details=None,
                escalation_info=None,
                chat_transcript=None,
            ...
            TicketResponse(
                ...
                actions_taken=[
                    ActionLogItem(id="act-1044-1", timestamp="2026-08-29T08:20:00Z", action="Inspected Duo Cloud Gateway webhook latency", actor="ai_specialist", result="APNs push delivery queue delayed; instructed users to use 6-digit passcode")
                ],
                resolution_details=None,
                escalation_info=None,
                chat_transcript=None,
            ...
            TicketResponse(
                ...
                actions_taken=[
                    ActionLogItem(id="act-1045-1", timestamp="2026-08-29T09:10:00Z", action="Correlated high-concurrency upload traffic spike in reverse proxy", actor="ai_specialist", result="Proxy buffer overflow on multipart file ingest")
                ],
                resolution_details=None,
                escalation_info=EscalationDetails(tier="Tier-2 Technical Escalation", department="Campus IT Systems Engineering", reason="Affects university-wide midterm submissions with imminent deadline", notes="Scaled backend container pool and notified academic deans", tech_bar_location="Main Library, 1st Floor Tech Bar (Mon-Fri 8:00 AM - 7:00 PM)", student_id_required=True, escalated_at="2026-08-29T09:15:00Z"),
                chat_transcript=None,
                notes=[
            ...
            TicketResponse(
                ...
                actions_taken=[
                    ActionLogItem(id="act-1047-1", timestamp="2026-08-29T08:45:00Z", action="Pinged LMTOOLS license host on port 27000", actor="ai_specialist", result="TCP connection refused on port 27000; daemon service stopped")
                ],
                resolution_details=None,
                escalation_info=None,
                chat_transcript=None,
            ...
            TicketResponse(
                ...
                actions_taken=[
                    ActionLogItem(id="act-1048-1", timestamp="2026-08-29T07:45:00Z", action="Verified student ID through institutional biometric verification record", actor="ai_specialist", result="Identity confirmed"),
                    ActionLogItem(id="act-1048-2", timestamp="2026-08-29T07:50:00Z", action="Dispatched secure password reset token via SMS", actor="technician", result="NetID unlocked and password successfully updated")
                ],
            ...
            TicketResponse(
                ...
                actions_taken=[
                    ActionLogItem(id="act-1051-1", timestamp="2026-08-29T09:22:00Z", action="AI Incident Intelligence correlated incident with INC-2026-1042", actor="ai_specialist", result="Detected U-Block Wi-Fi Cluster with 94% similarity")
                ],
                resolution_details=None,
                escalation_info=None,
                chat_transcript=None,
